...
const Input = /*#__PURE__*/forwardRef(function Input(props, forwardedRef) {
  ...
  const t1 = isFocused && !disableFocusRing;
  let t2;
...
function DateField(props, ref) {
  ...
  let t5;
  if ($[11] !== fieldRef || $[12] !== isReadOnly || $[13] !== fieldProps || $[14] !== isDisabled || $[15] !== autoFocus || $[16] !== t2.validationState || $[17] !== t3 || $[18] !== t4) {
  ...
  let t6;
  if ($[20] !== props || $[21] !== domRef || $[22] !== description || $[23] !== labelProps || $[24] !== descriptionProps || $[25] !== errorMessageProps || $[26] !== t5) {
...
function DatePicker(props, forwardedRef) {
  ...
  const t4 = isFocused && !isFocusedButton;
