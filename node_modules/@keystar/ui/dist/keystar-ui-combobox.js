...
import { u as usePrevious } from './usePrevious-a4dea1b5.js';
...
const ComboboxBase = /*#__PURE__*/React.forwardRef(function ComboboxBase(props, forwardedRef) {
  ...
  const t12 = loadingState === "loadingMore";
  let t13;
  if ($[33] !== isAsync || $[34] !== loadingState) {
    t13 = () => isAsync && /*#__PURE__*/jsx(ComboboxEmptyState, {
      loadingState: loadingState
    });
    $[33] = isAsync;
    $[34] = loadingState;
  ...
  let t14;
  if ($[36] !== listBoxProps || $[37] !== listBoxRef || $[38] !== state || $[39] !== layout || $[40] !== t12 || $[41] !== onLoadMore || $[42] !== t13) {
    t14 = /*#__PURE__*/jsx(ListBoxBase, {
      ...listBoxProps,
      ref: listBoxRef,
      disallowEmptySelection: true,
  ...
  let t15;
  if ($[44] !== state || $[45] !== popoverStyle || $[46] !== popoverRef || $[47] !== t10 || $[48] !== listBoxRef || $[49] !== t11 || $[50] !== shouldFlip || $[51] !== t14) {
...
const ComboboxMultiBase = /*#__PURE__*/React.forwardRef(function ComboboxMultiBase(props, forwardedRef) {
  ...
  const t9 = loadingState === "loadingMore";
  let t10;
  if ($[27] !== isAsync || $[28] !== loadingState) {
    t10 = () => isAsync && /*#__PURE__*/jsx(ComboboxEmptyState, {
      loadingState: loadingState
    });
    $[27] = isAsync;
    $[28] = loadingState;
  ...
  let t11;
  if ($[30] !== listBoxProps || $[31] !== listBoxRef || $[32] !== state || $[33] !== t9 || $[34] !== layoutDelegate || $[35] !== onLoadMore || $[36] !== t10) {
    t11 = /*#__PURE__*/jsx(ListBoxBase, {
      ...listBoxProps,
      ref: listBoxRef,
      autoFocus: state.focusStrategy,
      disallowEmptySelection: true,
  ...
  let t12;
  if ($[38] !== state || $[39] !== popoverStyle || $[40] !== popoverRef || $[41] !== t7 || $[42] !== listBoxRef || $[43] !== t8 || $[44] !== shouldFlip || $[45] !== t11) {
